...
<body class="bg-gradient-to-br from-teal-900 to-green-700 h-screen flex items-center justify-center">
    <div class="w-full max-w-4xl bg-teal-800 rounded-lg shadow-lg flex">
        ...
        <div class="w-1/2 p-8 bg-black text-white rounded-l-lg flex flex-col justify-center">
            ...
            <p class="text-sm mb-6">Silakan daftarkan diri anda</p>
            <form method="POST" action="./proses.php">
                <div class="mb-4">
                    <label for="name" class="block text-sm font-medium">Nama</label>
                    <input type="text" id="name" name="name" class="w-full mt-2 p-3 rounded bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="ex.ahmad rahmat">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    <label for="confPassword" class="block text-sm font-medium">Konfirmasi Kata Sandi</label>
                    <input type="password" id="confPassword" name="confPassword" class="w-full mt-2 p-3 rounded bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500">
                </div>
                <button type="submit" class="w-full bg-teal-600 hover:bg-teal-500 text-white py-2 px-4 rounded focus:outline-none">Daftar</button>
            </form>
            <div class="mt-6 flex justify-end items-center">
                <a href="../login/login.php" class="text-sm text-teal-400 hover:underline">sudah punya akun</a>
            </div>
        </div>
